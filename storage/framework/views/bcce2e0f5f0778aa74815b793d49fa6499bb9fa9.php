...
$message = $__bag->first($__errorArgs[0]); ?>
        <p class="text-gray-500 text-xs mt-1"><?php echo e($message); ?></p>
        <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="mb-6">
        ...
        <input type="text" class="border border-gray-200 rounded p-2 w-full" name="title"
          placeholder="Example: Senior Laravel Developer" value="<?php echo e(old('title')); ?>" />
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="mb-6">
        ...
        <input type="text" class="border border-gray-200 rounded p-2 w-full" name="location"
          placeholder="Example: Remote, Boston MA, etc" value="<?php echo e(old('location')); ?>" />
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="mb-6">
        ...
        <input type="text" class="border border-gray-200 rounded p-2 w-full" name="email" value="<?php echo e(old('email')); ?>" />
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="mb-6">
        ...
        <a href="/" class="bg-black text-white rounded py-2 px-4 hover:bg-black text-white ml-4"> Back </a>
      </div>
    </form>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH C:\laragon\www\laragigs-main\resources\views/listings/create.blade.php ENDPATH**/ ?>